...
public class SwaggerConfiguration {
	...
	private static final String GROUP_NAME = "account-manager-API";
	private static final String API_TITLE = "Account Manager API";
	private static final String API_VERSION = "1.0";
	private static final String API_DESCRIPTION = "API for Business Microservice AccountManager.";
	private static final String API_PATHS_REGEX = "/account.*";
